...
function buildCSS(t) {
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card::after { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg,rgba(226,185,78,0.02) 0%,transparent 55%); pointer-events: none; border-radius: 2px; }
  ...
  .empty-state { text-align: center; padding: 2rem 1rem; font-family: 'Crimson Text', Georgia, serif; font-size: 1rem; color: ${t.emptyColor}; font-style: italic; }
  .add-form { background: ${t.addForm}; border: 1px solid ${t.borderInput}; padding: 1rem; margin-bottom: 0.5rem; }
