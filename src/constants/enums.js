...
export const ITEM_TYPES_ENUM   = [ITEM_TYPE.GENERAL, ITEM_TYPE.WEAPON, ITEM_TYPE.ARMOR, ITEM_TYPE.SCROLL, ITEM_TYPE.WONDROUS, ITEM_TYPE.CONSUMABLE, ITEM_TYPE.TOOL, ITEM_TYPE.OTHER];
