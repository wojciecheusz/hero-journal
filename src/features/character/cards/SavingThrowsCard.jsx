        ...
        {SAVING_THROWS.map(st => {
          ...
          return (
            <div key={st.key} style={{ display:"flex", flexDirection:"column", gap:0 }}>
              <StatBox label={st.attr} value={char.stats[st.attr]}
              ...
              <div className="stat-box" style={{ borderTop:"none", textAlign:"center", padding:"0.25rem 0.1rem 0.2rem", display:"flex", flexDirection:"column", alignItems:"center", gap:0 }}>
                ...
                <input type="number" value={stVal}
                  style={{ background:"transparent", border:"none", outline:"none", fontFamily:"Cinzel,serif", fontSize:"0.85rem", fontWeight:700, color: over !== undefined ? "var(--pip-prof)" : "inherit", textAlign:"center", width:"100%", padding:"0.1rem 0", lineHeight:1, cursor:"text" }}
